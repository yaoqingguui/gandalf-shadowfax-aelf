...
namespace AElf.Contracts.ACS2DemoContract {
  ...
  #region Events
  #endregion
  internal static partial class ACS2DemoContractContainer
  {
    ...
    public class ACS2DemoContractStub : aelf::ContractStubBase
    {
      ...
      public aelf::IMethodStub<global::AElf.Contracts.ACS2DemoContract.TransferCreditsInput, global::Google.Protobuf.WellKnownTypes.Empty> TransferCredits
      {
        get { return __factory.Create(__Method_TransferCredits); }
      }
