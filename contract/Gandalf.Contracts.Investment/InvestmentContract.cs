...
{
    /// <summary>
    /// The C# implementation of the contract defined in investment_contract.proto that is located in the "protobuf"
    /// folder.
    /// Notice that it inherits from the protobuf generated code. 
    /// </summary>
    public class InvestmentContract : InvestmentContractContainer.InvestmentContractBase
    {
        /// <summary>
